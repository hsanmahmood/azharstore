    ...
    <div className={cardClasses}>
      <div className="flex flex-col h-full">
        <div className="flex justify-between items-start gap-2">
          <h3 className="text-lg font-bold text-text-dark flex-1 break-words">{translation.key}</h3>
        ...
        <p className="text-sm text-text-light mt-2 line-clamp-2">{translation.value}</p>
      </div>
    </div>
  );
};
