...
-- Create a table to store delivery areas and their prices
CREATE TABLE public.delivery_areas (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  name TEXT NOT NULL UNIQUE,
  price NUMERIC NOT NULL CHECK (price >= 0),
  min_for_free_delivery NUMERIC NOT NULL CHECK (price >= 0),
  created_at TIMESTAMPTZ DEFAULT NOW()
);

-- Create a generic table for application-wide settings
CREATE TABLE public.app_settings (
  key TEXT PRIMARY KEY,
  value TEXT
);

-- Insert the initial value for the free delivery threshold.
-- The default is '0', meaning free delivery is disabled until set.
...
CREATE TABLE public.orders (
    ...
    comments TEXT,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    delivery_area_id BIGINT REFERENCES public.delivery_areas(id) ON DELETE SET NULL,
